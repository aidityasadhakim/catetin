...
export const Card = React.forwardRef<HTMLDivElement, CardProps>(
  ({ className, variant = 'default', children, ...props }, ref) => {
    const variants = {
      ...
      parchment:
        'bg-parchment text-charcoal border border-border rounded-md p-8 shadow-inner font-accent italic leading-relaxed',
      technical:
        'bg-warm-cream border-2 border-black rounded-none p-6 relative technical-corners',
